...
void Foam::WallSpringSliderDashpotRolling<CloudType>::findMinMaxProperties
(
    scalar& rMin,
    scalar& rhoMax,
    scalar& UMagMax
...
template<class CloudType>
void Foam::WallSpringSliderDashpotRolling<CloudType>::evaluateWall
(
...
template<class CloudType>
Foam::WallSpringSliderDashpotRolling<CloudType>::WallSpringSliderDashpotRolling
(
...
template<class CloudType>
Foam::scalar Foam::WallSpringSliderDashpotRolling<CloudType>::pREff
(
...
template<class CloudType>
bool Foam::WallSpringSliderDashpotRolling<CloudType>::controlsTimestep() const
{
    return true;
}
...
template<class CloudType>
Foam::label Foam::WallSpringSliderDashpotRolling<CloudType>::nSubCycles() const
{
    if (!(this->owner().size()))
    {
        return 1;
