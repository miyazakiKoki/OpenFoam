...
void Foam::WallLocalSpringSliderDashpotRolling<CloudType>::findMinMaxProperties
(
    scalar& rMin,
    scalar& rhoMax,
    scalar& UMagMax
...
template<class CloudType>
void Foam::WallLocalSpringSliderDashpotRolling<CloudType>::evaluateWall
(
...
template<class CloudType>
Foam::WallLocalSpringSliderDashpotRolling<CloudType>::WallLocalSpringSliderDashpotRolling
(
...
template<class CloudType>
Foam::scalar Foam::WallLocalSpringSliderDashpotRolling<CloudType>::pREff
(
...
template<class CloudType>
bool Foam::WallLocalSpringSliderDashpotRolling<CloudType>::controlsTimestep() const
{
    return true;
}
...
template<class CloudType>
Foam::label Foam::WallLocalSpringSliderDashpotRolling<CloudType>::nSubCycles() const
{
    if (!(this->owner().size()))
    {
        return 1;
