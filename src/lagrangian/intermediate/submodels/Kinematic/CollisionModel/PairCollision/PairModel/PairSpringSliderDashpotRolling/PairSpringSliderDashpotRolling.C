...
void Foam::PairSpringSliderDashpotRolling<CloudType>::findMinMaxProperties
(
    scalar& RMin,
    scalar& rhoMax,
    scalar& UMagMax
...
template<class CloudType>
Foam::PairSpringSliderDashpotRolling<CloudType>::PairSpringSliderDashpotRolling
(
...
template<class CloudType>
bool Foam::PairSpringSliderDashpotRolling<CloudType>::controlsTimestep() const
{
    return true;
}
...
template<class CloudType>
Foam::label Foam::PairSpringSliderDashpotRolling<CloudType>::nSubCycles() const
{
    if (!(this->owner().size()))
    {
        return 1;
...
template<class CloudType>
void Foam::PairSpringSliderDashpotRolling<CloudType>::evaluatePair
(
