...
Foam::LambertDispersionNearestPointLBConst<CloudType>::LambertDispersionNearestPointLBConst
(
...
template<class CloudType>
void Foam::LambertDispersionNearestPointLBConst<CloudType>::evaluatePendular
(
