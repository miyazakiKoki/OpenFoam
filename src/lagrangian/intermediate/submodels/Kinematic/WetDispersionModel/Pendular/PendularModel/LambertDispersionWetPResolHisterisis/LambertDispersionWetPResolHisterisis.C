...
Foam::LambertDispersionWetPResolHisterisis<CloudType>::LambertDispersionWetPResolHisterisis
(
...
template<class CloudType>
void Foam::LambertDispersionWetPResolHisterisis<CloudType>::evaluatePendular
(
